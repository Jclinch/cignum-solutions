...
import Industries from "./industryPageClient";
    ...
    <div className="min-h-screen bg-[#050812] text-white">
      ...
      <header className="relative w-full h-[52vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="/hero2.avif"
            alt="Futuristic finance background showing innovation in industries"
            width={1920}
            height={1080}
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          <p className="mt-6 text-neutral-200 text-lg md:text-xl font-light tracking-wide">
            Purpose-built financial infrastructure for fintechs, marketplaces, remittances, NGOs, and enterprises.
          </p>
        </div>
      </header>
