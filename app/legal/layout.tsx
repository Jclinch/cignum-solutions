...
//   title: "Legal | Cignum Solutions",
//   description:
//     "Read Cignum Solutions’ legal documentation including Privacy Policy, Terms of Service, and Compliance disclosures.",
//   openGraph: {
//     title: "Legal | Cignum Solutions",
//     description:
//       "Access legal information about Privacy, Terms, and Compliance at Cignum Solutions.",
//     images: ["/hero2.avif"],
//   },
// };
...
//       {/* Content Section */}
//       <main className="flex flex-col md:flex-row px-6 md:px-16 lg:px-32 py-12 gap-12">
//         {/* Main Content */}
//         <div className="flex-1">{children}</div>

//         {/* Sidebar Navigation */}
//         <aside className="w-full md:w-72 bg-[#1E2A39] p-6 rounded-lg shadow-xl space-y-6 h-fit">
//           <h3 className="text-xl font-semibold text-white mb-4">Legal Pages</h3>
...
//                       : "text-neutral-300 hover:bg-cyan-500/20"
//                   }`}
//                 >
//                   {item.label}
//                 </Link>
