...
export const metadata: Metadata = {
  title: "Resources | Cignum Solutions",
  description:
    "Learn, build, and scale with Cignum Solutions. Explore technical guides, case studies, compliance playbooks, and product updates.",
  openGraph: {
    title: "Resources | Cignum Solutions",
    description:
      "Technical guides, case studies, compliance playbooks, and product updates — everything you need to build at scale with Cignum Solutions.",
    images: ["/hero2.avif"],
  },
};
    ...
    <div className="min-h-screen bg-[#050812] text-white">
      ...
      <header className="relative w-full h-[52vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="/hero2.avif"
            alt="Resources background showcasing futuristic learning"
            width={1920}
            height={1080}
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          <p className="mt-6 text-neutral-200 text-lg md:text-xl font-light tracking-wide">
            Access technical guides, case studies, compliance playbooks, and
            product updates to grow with Cignum Solutions.
          </p>
        </div>
      </header>
