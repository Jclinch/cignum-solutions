...
//           className="text-4xl sm:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-cyan-400 to-green-400 mb-12 text-center"
//         >
//           Three Value Pillars
//         </motion.h2>
...
//             {/* Paths connecting three columns (cards roughly at x: 200 / 600 / 1000) */}
//             {/* Left -> Center curve */}
//             <motion.path
...
//                   {pillar.icon}
//                   <h3 className="text-xl font-bold text-yellow-300">{pillar.title}</h3>
...
//           {/* Mobile stacked connectors (only show when grid is single column) */}
...
//       {/* Keyframe for mobile dashed movement (scoped via arbitrary value) */}
//       <style jsx>{`
//         @keyframes marquee {
//           0% {
